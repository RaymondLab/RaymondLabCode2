...
KEY = {'analysis'; 'analysis_date'; ...
    'exp_filepath'; 'num_blocks'; 'train_type'; 'stim_frequency'; 'sampling_rate'; 'lp_cutoff'; 'sg_window'; ...
...
VALUE = {'ndd_okrAnalysis'; string(datetime('now')); ...
    params.exp_filepath; nblocks; params.exp_traintype; params.exp_stimfreq; params.fs; params.lowpassCutoff; params.filterWindow; ...
