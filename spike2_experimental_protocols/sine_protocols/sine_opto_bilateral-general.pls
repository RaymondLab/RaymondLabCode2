...
OPTOON: 'T  MOVI   BlockFlg,1      ;Start opto stim trials >TRAINING
            MOVI   DelIdx,0        ;Reset trial index for this training block
            MOVI   DrumTmp,0       ;Set drum amplitude >"
            MOV    ChairTmp,ChairAmp ;Set chair amplitude >"
...
ILB:        BEQ    DelValB,-1,ILC  ;Skip stim (i.e. NoStim) if value = -1 >"
            DELAY  DelValB         ;                   >"
            DIGPS  2,P,PulInt      ;Pulse every "PulInt" ms >"
            DIGPS  2,D,PulDur      ;Pulse has duration of "PulDur" ms >"
            DIGPS  2,C,PulNCycl    ;Set number of pulses in train >"
...
ILC:        BEQ    DelValC,-1,ILD  ;Skip stim (i.e. NoStim) if value = -1 >"
            DELAY  DelValC         ;                   >"
            DIGPS  2,P,PulInt      ;Pulse every "PulInt" ms >"
            DIGPS  2,D,PulDur      ;Pulse has duration of "PulDur" ms >"
            DIGPS  2,C,PulNCycl    ;Set number of pulses in train >"
...
ILE:        BEQ    DelValE,-1,ILF  ;Skip stim (i.e. NoStim) if value = -1 >"
            DELAY  DelValE         ;                   >"
            DIGPS  3,P,PulInt      ;Pulse every "PulInt" ms >"
            DIGPS  3,D,PulDur      ;Pulse has duration of "PulDur" ms >"
            DIGPS  3,C,PulNCycl    ;Set number of pulses in train >"
...
ILF:        BEQ    DelValF,-1,OPTO2 ;Skip stim (i.e. NoStim) if value = -1 >"
            DELAY  DelValF         ;                   >"
            DIGPS  3,P,PulInt      ;Pulse every "PulInt" ms >"
            DIGPS  3,D,PulDur      ;Pulse has duration of "PulDur" ms >"
            DIGPS  3,C,PulNCycl    ;Set number of pulses in train >"
...
CLB:        BEQ    DelValB,-1,CLC  ;Skip stim (i.e. NoStim) if value = -1 >"
            DELAY  DelValB         ;                   >"
            DIGPS  3,P,PulInt      ;Pulse every "PulInt" ms >"
            DIGPS  3,D,PulDur      ;Pulse has duration of "PulDur" ms >"
            DIGPS  3,C,PulNCycl    ;Set number of pulses in train >"
...
CLC:        BEQ    DelValC,-1,CLD  ;Skip stim (i.e. NoStim) if value = -1 >"
            DELAY  DelValC         ;                   >"
            DIGPS  3,P,PulInt      ;Pulse every "PulInt" ms >"
            DIGPS  3,D,PulDur      ;Pulse has duration of "PulDur" ms >"
            DIGPS  3,C,PulNCycl    ;Set number of pulses in train >"
...
CLE:        BEQ    DelValE,-1,CLF  ;Skip stim (i.e. NoStim) if value = -1 >"
            DELAY  DelValE         ;                   >"
            DIGPS  2,P,PulInt      ;Pulse every "PulInt" ms >"
            DIGPS  2,D,PulDur      ;Pulse has duration of "PulDur" ms >"
            DIGPS  2,C,PulNCycl    ;Set number of pulses in train >"
...
CLF:        BEQ    DelValF,-1,OPTO2 ;Skip stim (i.e. NoStim) if value = -1 >"
            DELAY  DelValF         ;                   >"
            DIGPS  2,P,PulInt      ;Pulse every "PulInt" ms >"
            DIGPS  2,D,PulDur      ;Pulse has duration of "PulDur" ms >"
            DIGPS  2,C,PulNCycl    ;Set number of pulses in train >"
...
OPTO3:      OFFSET 0,DrumOff       ;Adjust drum cosine offset >"
            OFFSET 1,ChairOff      ;Adjust chair cosine offset >"
