function axesCustomToolbarButtons(ax, interactions, description)
...
%   interactions: (Optional) Custom interactions
%   description : (Optional) Custom description text for the subplot
%
%   ----------------------------------------------------------------------
...
infoBtn = axtoolbarbtn(tb, 'push', 'Icon','info_icon.gif');
infoBtn.ButtonPushedFcn = {@showDescription, ax, description};
infoBtn.Tooltip = 'Show Subplot Info';
