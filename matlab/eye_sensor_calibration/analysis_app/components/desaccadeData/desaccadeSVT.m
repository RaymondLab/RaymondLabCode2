function [saccadeLocs, eye_pos_filt, eye_vel_pfilt] = desaccadeSVT(data, samplerate, freq, presaccade, postsaccade, thresh, minDataLength, fc, mslen)
%DESACCADESVT
...
% Remove experiment frequency by taking squared error from initial fit guess
